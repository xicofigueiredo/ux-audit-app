...
class VideoProcessingJob < ApplicationJob
  ...
  def perform(video_audit_id)
    ...
    begin
      ...
      # Extract frames using FFmpeg directly (3 frames per second)
      require 'shellwords'
      ...
      ffmpeg_command = "#{ffmpeg_path} -i #{Shellwords.escape(video_path)} -vf fps=3 #{Shellwords.escape(frames_dir)}/frame_%04d.jpg"
